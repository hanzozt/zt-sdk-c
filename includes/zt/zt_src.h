...
/**
 * @file zt_src.h
 * @brief header file for zt_src, which can be used as a source link in um_http requests
 *
 ...
 * @param ztx the initialized zt_context
 */
int zt_src_init(uv_loop_t *l, tlsuv_src_t *zl, const char *svc, zt_context ztx);
